...
public class FontHandler {
    ...
    private final int datatableStep;

    public FontHandler(File fontFile, int step) {
        datatableStep = step;
        try {
    ...
    public HashMap<String,String> ConvertFontFile() {
        this.FindChangedUnicodeCharacters();
        HashMap<String,String> firstLayeredHashmap = this.GetCharacterFills();
        HashMap<String,String> simplifiedLayerHashmap = this.SimplifyCharacterFills(firstLayeredHashmap);
        return CreateFinalHashmap(simplifiedLayerHashmap,datatableStep);
    }

    public void FindChangedUnicodeCharacters() {
